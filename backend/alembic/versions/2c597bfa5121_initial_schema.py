...
Revises:
Create Date: 2026-08-25 09:55:45.273267
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("TAG", "GENRE", name="categorytypeenum"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "COMMON", "MANAGER", name="userroleenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("PUBLISHERS", "AUTHORS", "TRANSLATORS", name="teamtype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("ORIGINAL", "AUTHORS", name="noveltype"), nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum("FROZEN", "CONTINUES", "COMPLETED", "ABADONED", name="novelstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("CREATOR", "MANAGER", "NEWBIE", name="teamuserrole"),
            nullable=False,
        ),
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column("team_id", sa.Integer(), nullable=False),

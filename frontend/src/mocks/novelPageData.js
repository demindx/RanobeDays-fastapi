...
export const novelPageData = [
	{
		...
		readingProgress: 43,
		chapters: [
			{ id: 'c-1', number: 127, title: 'Ночь перед советом', publishedAt: '2026-04-10', isRead: true },
			{ id: 'c-2', number: 128, title: 'Цена обещаний', publishedAt: '2026-04-12', isRead: true },
			{ id: 'c-3', number: 129, title: 'Клятва на пепле', publishedAt: '2026-04-14', isRead: false },
...
const buildNovelFromCatalog = (id) => {
	...
	return {
		...
		readingProgress: 0,
		chapters: [
			{ id: `${source.id}-c1`, number: currentChapter, title: 'Последний релиз', publishedAt: '2026-04-12', isRead: false },
			{ id: `${source.id}-c2`, number: currentChapter + 1, title: 'Новая глава', publishedAt: '2026-04-14', isRead: false }
		],

...
<template>
	...
	<div
		:class="['fixed inset-0 z-50 lg:hidden', props.filtersOpen ? 'pointer-events-auto' : 'pointer-events-none']"
	>
		<div
			:class="['absolute inset-0 bg-black/50 transition-opacity', props.filtersOpen ? 'opacity-100' : 'opacity-0']"
